...
type (
	...
	// OpenAIImageEditsTranslator translates the OpenAI's /images/edits endpoint.
	OpenAIImageEditsTranslator = Translator[openai.ImageEditRequest, tracingapi.ImageEditsSpan]
